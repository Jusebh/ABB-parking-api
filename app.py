...
from blueprints.admin.post import receive_new_user_data, receive_new_reservation_data
...
from blueprints.user.post import receive_reservation_data, receive_user_data, receive_reservation_date
